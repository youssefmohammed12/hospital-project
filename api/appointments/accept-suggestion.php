...
try {
    ...
    echo json_encode($rs->acceptRescheduleSuggestion((int)$input['appointment_id']));
} catch (Exception $e) {
    error_log('Accept Suggestion Error: ' . $e->getMessage());
    echo json_encode(['success' => false, 'message' => 'Failed to accept suggestion.']);
}
