<?php
/**
 * HealthBridge — Delete Department
 * Permanently deletes a department (only if no dependencies).
 * Admin-only endpoint.
 */
...
try {
    ...
    try {
        ...
        $audit->logDepartmentDelete($departmentId, $department);

        $db->commit();

        jsonResponse(true, ['message' => 'Department deleted successfully.']);
